...
Time::Time(Triad& tr)
{
	value_1 = tr.get_value_1();
	value_2 = tr.get_value_2();
	value_3 = tr.get_value_3();
}
...
Time Time::val_1_increase_1()
{
	...
	this->value_1 = triad.get_value_1();
	this->normalized();
	return *this;
}
...
Time Time::val_2_increase_1()
{
	...
	this->value_2 = triad.get_value_2();
	this->normalized();
...
Time Time::val_3_increase_1()
{
	...
	this->value_3 = triad.get_value_3();
	this->normalized();
